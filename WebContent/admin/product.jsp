...
<!-- main -->
 ...
 <tr>
   <td>2</td>
    <td><img src="../img/img-product/product-1.jpg" alt="" width="100px" height="50px"></td>
 ...
 <tr>
   <td>3</td>
    <td><img src="../img/img-product/product-3.png" alt="" width="100px" height="50px"></td>
...
<tr>
   <td>4</td>
    <td><img src="../img/img-product/product-4.png" alt="" width="100px" height="50px"></td>
...
<tr>
   <td>5</td>
    <td><img src="../img/img-product/product-5.png" alt="" width="100px" height="50px"></td>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <input class="form-control " type="text" placeholder="Nhập tên sản phẩm">
          ...
          <div class="form-group">
        <input class="form-control " type="text" placeholder="Tải hình ảnh">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <textarea rows="2" class="form-control" placeholder="Nhập số lượng"></textarea>
    
        
        </div>
      </div>
          <div class="modal-footer ">
        <button type="button" class="btn btn-success btn-lg" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span> Cập nhật</button>
      </div>
        </div>
    <!-- /.modal-content --> 
  </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="form-group">
        <textarea rows="2" class="form-control" placeholder="30"></textarea>
