					...
					<div class="col-md-6">
						...
						<form action="AddProductController" method="post"
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<textarea id="content" class="form-control" name="des"
							...
							<div>
								<a onclick="document.getElementById('myform').submit()"
									class="btn btn-success btn-lg" style="width: 100%;color: white;"><span
									class="glyphicon glyphicon-ok-sign"></span> Thêm</a>
							</div>
						</form>
