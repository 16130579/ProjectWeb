...
<!-- main -->
   ...
   <td><%=o.getId() %></td>
    <td><%=o.getCreateAt() %></td>
    <% User us = UserDAO.getThongTinUser(o.getUser_id());%>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Record?</div>
        ...
        <a href="DeleteOrder?id=<%=o.getId()%>"><button type="button" class="btn btn-success" ><span class="glyphicon glyphicon-ok-sign"></span> Yes</button></a>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
          <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 style="margin-right: 32%;" class="modal-title custom_align" id="Heading">Edit Your Detail</h4>
      </div>
          <div class="modal-body">
        ...
        <input class="form-control " type="text" placeholder="12/11/2019">
        </div>
        <div class="form-group">
        
        <input class="form-control " type="text" placeholder="190,000 đ">
        </div>
        <div class="form-group">
        <textarea rows="2" class="form-control" placeholder="Hoàn tất"></textarea>
