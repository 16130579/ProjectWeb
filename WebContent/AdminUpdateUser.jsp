				...
				<div id="collapseTwo" class="collapse show"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item " href="adminUser.jsp">Account</a> <a
							class="collapse-item active" href="adminproduct.jsp">Product</a> <a
							...
							<div class="col-md-6">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<form action="AdminUpdateUser" method="post" id="editcode">
											...
											<div class="modal-body">
												...
												<div class="form-group">
													...
													<input class="form-control " name="cmnd" type="number"
														value="<%=user.getCmnd()%>">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<input class="form-control" name="phone" type="number"  value="<%=user.getPhone()%>"></input>
												</div>
												<div class="form-group">
													<input class="form-control" name="balance" type="number" value="<%=user.getBalance()%>"></input>
												</div>
												<% ArrayList<Role> listRole = UserDAO.getListRole(); %>
												<div class="form-group">
												<select name="role"  class="form-control">
												<%for (Role item : listRole){ %>
												<%if(user.getRole()==item.getId()){ %>
													
													<option value="<%= user.getRole()%>" selected><%=item.getName() %></option>
													<%}else{ %>
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title custom_align" id="Heading"
										style="margin-right: 32%;">Xóa người dùng này phẩm này</h4>
								</div>
								<div class="modal-body">
